...
class DescriptionCard {
    ...
    // =============================================================================
    // COMMAND MODE HELPER - NAUJAS METODAS
    // =============================================================================
    
    getCommandMode() {
        if (!this.app || !this.app.cards) return { mode: 'add', taskId: null };
        
        const commandModeCard = this.app.cards.get('commandmode');
        if (commandModeCard && commandModeCard.instance && commandModeCard.instance.getValue) {
            return commandModeCard.instance.getValue();
        }
        
        return { mode: 'add', taskId: null };
    }
    ...
    // =============================================================================
    // VALIDATION SU COMMAND MODE PALAIKYMU - PATAISYTA
    // =============================================================================
    
    isValid() {
        const commandMode = this.getCommandMode();
        
        // MODIFY režime description neprivalomas
        if (commandMode.mode === 'modify') {
            return true;
        }
        
        // ADD režime description privalomas
    ...
    getValidationMessage() {
        ...
        if (!this.description.trim()) {
            return 'DESCRIPTION laukas yra privalomas ADD režime!';
        }
        return '';
    }
}
