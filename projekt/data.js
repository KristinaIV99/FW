...
const DATA = {
    ...
    PROJECTS: [
        ...
        'SFI.SAS',
        'SFI_ENGELSKA',
        'SFI_ENGELSKA.LEVEL-1',
        'SFI_ENGELSKA.LEVEL-2',
        'AnkiDu',
        'AnkiDu.INFO',
        'AnkiDu.programming',
        'NOMI',
        ...
        'DB.svenska',
        'DB.svenska.WORDS',
        'DB.svenska.FORMS-FRAS',
        'DB.svenska.WORDS_INFO',
        'DB.svenska.FRAS_INFO',
        'DB.svenska.CONTEXT',
        'DB.english',
        'DB.english.WORDS',
        'DB.english.FORMS-FRAS',
        'DB.english.WORDS_INFO',
        'DB.english.FRAS_INFO',
        'DB.english.CONTEXT',
        'MIGRENA',
        'MIGRENA.programming',
        'TASKWARRIOR',
        'TASKWARRIOR.programming',
        'TASKWARRIOR.TelegramBot',
        'TASKWARRIOR.help',
        'HOME',
        'HOME.sewing',
        'HOME.cleaning',
    ...
    TAGS: {
        ...
        PROJECTS: ['birthdays', 'finances', 'book', 'career', 'YouTube'],
        OTHER: ['mind', 'chaos', 'ideas']
    },
...
- TASKWARRIOR: čia galimos užduotys susijusios su programavimu, Telegram Botu ir help teksto kūrimu.
- BUNI.DB.INFO: visokia informacija susijusi su MongoDB tvarkymu, veiksmų atlikimu, informacija kurios nenoriu pamiršti.
