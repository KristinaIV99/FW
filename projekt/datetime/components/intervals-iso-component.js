        ...
        container.innerHTML = `
            <div class="iso-input-container">
                ...
                <div class="iso-inputs">
                    <input type="number" id="isoYears" class="iso-input" min="${validation.YEARS_MIN}" max="${validation.YEARS_MAX}" placeholder="YY" value="">
                    <span class="iso-separator">:</span>
                    <input type="number" id="isoMonths" class="iso-input" min="${validation.MONTHS_MIN}" max="${validation.MONTHS_MAX}" placeholder="MM" value="">
                    <span class="iso-separator">:</span>
                    <input type="number" id="isoDays" class="iso-input" min="${validation.DAYS_MIN}" max="${validation.DAYS_MAX}" placeholder="DD" value="">
                    <span class="iso-separator">:</span>
                    <input type="number" id="isoHours" class="iso-input" min="${validation.HOURS_MIN}" max="${validation.HOURS_MAX}" placeholder="HH" value="">
                    <span class="iso-separator">:</span>
                    <input type="number" id="isoMinutes" class="iso-input" min="${validation.MINUTES_MIN}" max="${validation.MINUTES_MAX}" placeholder="MM" value="">
                </div>
                <div class="helper-text">Metai : Mėnesiai : Dienos : Valandos : Minutės</div>
                <div class="iso-preview" id="isoPreview" style="display: none;"></div>
            </div>
        `;
    ...
    updatePreview() {
        if (this.inputElements.preview) {
            if (this.currentIso === 'P') {
                this.inputElements.preview.textContent = '';
                this.inputElements.preview.style.display = 'none';
            } else {
                this.inputElements.preview.textContent = this.currentIso;
                this.inputElements.preview.style.display = 'flex';
            }
        }
    }
