...
const CACHE_NAME = 'taskwarrior-composer-v3';
const STATIC_ASSETS = [
    '/FW/',
    '/FW/index.html',
    '/FW/projekt/localStorage-manager.js',
    '/FW/projekt/config.js',
    '/FW/projekt/data.js',
    '/FW/projekt/export-manager.js',
    '/FW/projekt/app.js',
    '/FW/projekt/css/main.css',
    '/FW/manifest.json',
...
self.addEventListener('push', event => {
    if (event.data) {
        ...
        event.waitUntil(
            self.registration.showNotification('Taskwarrior Composer', options)
        );
    }
});
